...
require("mason-lspconfig").setup({
	-- ensure_installed = { "lua_ls", "clangd", "fortls", "pyright", "jedi_language_server", "bashls", "julials", "texlab" },
	ensure_installed = { "lua_ls", "clangd", "fortls", "pyright", "bashls", "julials", "texlab" },
})
